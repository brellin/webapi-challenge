...
- [x] Describe Middleware.
    ...
    * A function that performs an action, then either calls the next middleware or returns the response from the server

- [x] Describe a Resource.

    * Pre-compiled information or data that makes for handy reference or easy implementation.
